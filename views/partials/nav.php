<nav class="bg-gray-800">
                            ...
                            <?php if ($_SESSION['user'] ?? false): ?>
                                ...
                                <div class="ml-3">
                                    <form method="POST" action="/logout">
                                        ...
                                        <button type="submit"
                                            class="text-white text-gray-300 hover:bg-gray-700 hover:text-white'; ?> rounded-md px-3 py-2 text-sm font-medium">Log
                                            Out</button>
                                    </form>
                                </div>
                            <?php else: ?>
    ...
    <div class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            <a href="/"
                class="<?= urlIs('/') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'; ?> block rounded-md px-3 py-2 text-base font-medium"
                aria-current="page">Home</a>
            <a href="/about"
